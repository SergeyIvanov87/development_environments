...
docker run -it -e \
    ...
    --mount type=bind,src=${WORKSPACE_PATH},dst=/home/user/data \
    -v codec_ide_env.sshkeys.volume:/sshkeys \
    -v codec_ide_env.browser.data.volume:/home/user/.config/mozilla/firefox \
    --name codex_ide_env_cont \
    is140608/codex_ide_env:0.0.1
